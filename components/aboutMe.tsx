    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        <div data-gsap="section-header" className="text-center mb-16">
          ...
          <div data-gsap="section-underline" className={`w-24 h-1 mx-auto rounded-full ${
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div data-gsap="stagger-group" className="space-y-6">
            <p data-gsap="stagger-item" className={`text-lg leading-relaxed ${
              isDark ? 'text-gray-300' : 'text-gray-700'
            }`}>
              I&apos;m a passionate AI researcher and full-stack developer with over 8 years of experience with over 8 years of experience 
            ...
            {/* Skills */}
            <div className="pt-6" data-gsap="stagger-item">
              <h3 className={`text-xl font-semibold mb-4 ${
                isDark ? 'text-white' : 'text-gray-900'
              }`}>
                Core Skills
              </h3>
              <div className="flex flex-wrap gap-2" data-gsap="skills-group">
                {[
